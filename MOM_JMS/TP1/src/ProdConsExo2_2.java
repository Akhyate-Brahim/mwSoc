...
public class ProdConsExo2_2 implements javax.jms.MessageListener{
    ...
    private void configurerProducteur() throws JMSException, NamingException{
    	// Dans ce programme, on decide que ce client JMS decouvre la queue par un lookup JNDI 
    	// (ce qui la crééra si le nom n'est pas encore utilisé) 
