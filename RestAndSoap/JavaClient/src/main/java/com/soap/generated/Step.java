...
public class Step {
    ...
    @XmlElementRef(name = "Instruction", namespace = "http://schemas.datacontract.org/2004/07/RouteService", type = JAXBElement.class, required = false)
    protected JAXBElement<String> instruction;
    @XmlElementRef(name = "Name", namespace = "http://schemas.datacontract.org/2004/07/RouteService", type = JAXBElement.class, required = false)
    protected JAXBElement<String> name;
    @XmlElement(name = "Type")
    protected Integer type;
    @XmlElementRef(name = "WayPoints", namespace = "http://schemas.datacontract.org/2004/07/RouteService", type = JAXBElement.class, required = false)
